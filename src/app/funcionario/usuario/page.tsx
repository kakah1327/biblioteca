...
export default function ListaUsuarios() {
  ...
  useEffect(() => {
    fetchUsuarios(); // Carrega os dados inicialmente
  }, []);
  ...
  const salvarAlteracoes = (usuarioAtualizado: Usuario) => {
    // Após salvar as alterações, recarregar a lista de usuários
    fetchUsuarios(); // Chama novamente a função para recarregar a lista de usuários
    fecharModal();
  };
